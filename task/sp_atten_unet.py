...
def Net(n_classes, input):
    ...
    # x = conv_block(x, 512, (3, 3), strides=1, name='bottom-2')
    ...
    x = sp_block_1(x) # Spatial attention
    # x = sp_block_2(x) # Spatial attention
    ...
    final = Activation('softmax', name='softmax_final0')(final)
